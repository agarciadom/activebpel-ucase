// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel.server/src/org/activebpel/rt/bpel/server/deploy/AeDeploymentHandler.java,v 1.17 2007/02/16 00:17:1
/*
...
/**
 *  Deployes an IAeDeploymentContainer.
 */
public class AeDeploymentHandler extends AeAbstractDeploymentHandler
{
   ...
   /**
    * Deploy all BPEL processes in the cotnainer.
    * @param aContainer
    * @throws AeException
    */
      ...
      for( Iterator iter = aContainer.getPddResources().iterator(); iter.hasNext(); )
      {
         ...
         try
         {
            ...
            if( !getDeploymentLogger().hasErrors() )
            {
               ...
               AeServiceMap.getInstance().addServiceData(services);
