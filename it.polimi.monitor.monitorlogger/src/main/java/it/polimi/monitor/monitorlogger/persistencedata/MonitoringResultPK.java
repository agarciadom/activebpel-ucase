...
@Embeddable
public class MonitoringResultPK implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 9125373023547377860L;
	...
	public MonitoringResultPK()
	{
		// TODO Auto-generated constructor stub
	}

	public MonitoringResultPK(Date date, String processID, String userID, String location, boolean isPrecondition)
	{
		this.date = date;
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		final MonitoringResultPK other = (MonitoringResultPK) obj;
		if (date == null)
		{
			if (other.date != null)
				return false;
