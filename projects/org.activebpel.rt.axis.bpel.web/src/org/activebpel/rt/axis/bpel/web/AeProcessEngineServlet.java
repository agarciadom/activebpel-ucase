// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.axis.bpel.web/src/org/activebpel/rt/axis/bpel/web/AeProcessEngineServlet.java,v 1.35 2006/07/18 20:11:1
/*
...
public class AeProcessEngineServlet extends AxisServlet implements IAeCatalogListener
{
   ...
   protected File initServletHome( ServletConfig aConfig ) throws AeException
   {
      ...
      {
         servletHomePath = AeUtil.replacePropertyVars( servletHomePath, System.getProperties() );
      }
   ...
   protected File getFile( File aServletHome, String aParamKey, String aDefaultPath, ServletConfig aConfig )
   {
      ...
      {
         filePath = AeUtil.replacePropertyVars( filePath, System.getProperties() );
      }
