//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/activity/AeActivityForEachImpl.java,v 1.11 2006/10/25 16:08:0
/*
...
public class AeActivityForEachImpl extends AeLoopActivity implements IAeActivityParent
{
   ...
   protected int evaluateUnsignedIntegerExpression(IAeExpressionDef aExpressionDef) throws AeBusinessProcessException, AeUnsignedIntException
   {
      ...
      if (value >=0 && Double.compare(value, Math.ceil(value)) == 0)
      {
         return (int) value; 
      }
