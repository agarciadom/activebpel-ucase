// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/AeBaseQueueManager.java,v 1.36 2007/08/01 18:17:3
/*
                   ...
                   throws AeCorrelationViolationException, AeConflictingRequestException, AeBusinessProcessException
   {
      synchronized(getUnmatchedReceives())
      {
         synchronized(getMessageReceivers())
         {
            ...
            {
               // message receiver (onMessage, Receive acitivity not found: hold onto this inbound receive in case a mesasge receiver executes and consumes it).
