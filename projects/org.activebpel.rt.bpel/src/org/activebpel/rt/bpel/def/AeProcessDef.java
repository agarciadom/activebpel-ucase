// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/AeProcessDef.java,v 1.71 2007/06/08 20:17:5
/*
...
public class AeProcessDef extends AeScopeDef
{
   ...
   /** A map of parnter link names to fully qualified partner link locations. */
    ...
    *
    * @param aPartnerLink
    * @throws AeAmbiguousPartnerLinkException
    */
   ...
   protected String findAvailablePrefix(String aPreferredPrefix, String aNamespace)
   {
      ...
      String ns = findNamespace(aPreferredPrefix);
