...
public class AndNode extends WSReLNode
{
	//It can be another 'and' node or a 'recovery action' node
	private WSReLNode first = null;
	//It is only a 'recovery action' node
	private WSReLNode second = null;
	/**
	 * 
	 */
	private static final long serialVersionUID = -3202276609050108991L;
...
//		//If there was an 'ignore' action, the recovery ends.
//		if(/*this.recoveryResult.isThereHaltAction() ||*/ recoveryResult.isThereIgnoreAction())
//		{
//			return;
//		}
