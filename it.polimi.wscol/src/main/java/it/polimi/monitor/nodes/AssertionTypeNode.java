...
public class AssertionTypeNode extends NodeWSCoL {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8363604350684023249L;
	...
	public Integer getMonitoringValue() throws WSCoLException {
		...
		try {
			...
			throw new IncompleteInformationException("Retrieve without assertionType");
		}
		if (assType==-1)
			throw new IncompleteInformationException("Retrieve without assertionType");
		return assType;
