...
public class ProcessIdNode extends NodeWSCoL {

	private static final long serialVersionUID = -1564255150332171967L;
	...
	public String getMonitoringValue() throws WSCoLException {
		if (value == null)
			throw new IncompleteInformationException("Retrieve without processID");
		return value;
	}
	@Override
