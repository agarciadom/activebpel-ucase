...
public class NumberOperatorNode extends BinaryNode {
	...
	private Object plusOperation()  throws WSCoLCastException {
		switch (instace) {
			...
			case BOOLEAN: //non si può fare gt di booleani
				...
				throw new WSCoLCastException("Can't define plus operation beetwen boolean");
			default:
				//caso inverosimile
				return null;
		}
	...
	private Double minusOperation()  throws WSCoLCastException{
		switch (instace) {
			...
			case STRING:
				logger.severe("WSCoLCastException");
				throw new WSCoLCastException("Can't define substraction beetwen string");
			case BOOLEAN: //non si può fare gt di booleani
				logger.severe("WSCoLCastException");
				throw new WSCoLCastException("Can't define substraction beetwen boolean");
			default:
				//caso inverosimile
				return null;
		}
	...
	private Double starOperation()  throws WSCoLCastException {
		switch (instace) {
			...
			case STRING:
				logger.severe("WSCoLCastException");
				throw new WSCoLCastException("Can't define multiplication beetwen string");
			case BOOLEAN: //non si può fare gt di booleani
				logger.severe("WSCoLCastException");
				throw new WSCoLCastException("Can't define multiplication beetwen boolean");
			default:
				//caso inverosimile
				return null;
		}
	...
	private Double slashOperation()  throws WSCoLCastException {
		switch (instace) {
			...
			case BOOLEAN: //non si può fare gt di booleani
				logger.severe("WSCoLCastException");
				throw new WSCoLCastException("Can't define division beetwen boolean");
			default:
				//caso inverosimile
				return null;
		}
	...
	private Double percentageOperation() throws WSCoLCastException {
		switch (instace) {
			...
			case STRING:
				logger.severe("WSCoLCastException");
				throw new WSCoLCastException("Can't define percentage beetwen string");
			case BOOLEAN: //non si può fare gt di booleani
				logger.severe("WSCoLCastException");
				throw new WSCoLCastException("Can't define percentage beetwen boolean");
			default:
				//caso inverosimile
				return null;
		}
