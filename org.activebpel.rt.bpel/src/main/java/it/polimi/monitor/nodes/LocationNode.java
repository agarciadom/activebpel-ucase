...
public class LocationNode extends NodeWSCoL {
	
	private static final long serialVersionUID = -8977726515363514742L;
	...
	public void evaluate(InputMonitor inputMonitor, Aliases aliases,
		...
		node.evaluate(inputMonitor, aliases, aliasNodes);
	...
	public String getMonitoringValue() throws WSCoLException {
		if (value == null)
			throw new IncompleteInformationException("Retrieve without location");
		return value;
	}
	@Override
