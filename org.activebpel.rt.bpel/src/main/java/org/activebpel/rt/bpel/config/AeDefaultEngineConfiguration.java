// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/config/AeDefaultEngineConfiguration.java,v 1.33 2007/05/04 18:35:1
/*
      ...
      IAeUpdatableEngineConfig, Cloneable
{
   ...
   /**
    * @see com.activee.rt.bpel.versioning.engine.config.IAeUpdatableStandardConfig#addNewFunctionContext(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
    */
   ...
   /**
    * @see org.activebpel.rt.bpel.config.IAeEngineConfiguration#getWebServiceTimeout()
    */
   ...
   {
      return getBooleanEntry(SUSPEND_PROCESS_ENTRY, false);
   }
   ...
   {
      setBooleanEntry(SUSPEND_PROCESS_ENTRY, aFlag);
   }
    ...
    * constructer and then calling that constructor.  Any class can use this method, 
