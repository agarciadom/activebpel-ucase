// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/config/IAeEngineConfiguration.java,v 1.41 2007/08/07 00:57:5
/*
...
public interface IAeEngineConfiguration
{
   ...
   public static final String SUSPEND_PROCESS_ENTRY = "SuspendProcessOnUncaughtFault"; //$NON-NLS-1$
   ...
   /**
    * Returns a desicription for this engine configuration.
    */
    ...
    * message to be completed. This affects inbound message activities in a process as well
    * as request-response style invokes.
