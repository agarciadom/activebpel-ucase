// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/AeAbstractBpelObject.java,v 1.82 2007/06/19 15:28:3
/*
      ...
      IAeNamespaceContext, IAeFunctionFactory
{
    ...
    */
   public abstract void accept( IAeImplVisitor aVisitor ) throws AeBusinessProcessException;
 ...
 * @param aExpressionDef 
   ...
   {
      return AeDefUtil.translateNamespacePrefixToUri(getDefinition(), aPrefix);
   }
   ...
   {
      return AeDefUtil.getPrefixesForNamespace(getDefinition(), aNamespace);
   }
