// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/activity/AeActivityCompensateImpl.java,v 1.32 2006/11/10 03:57:5
/*
...
public class AeActivityCompensateImpl extends AeActivityImpl implements IAeCompensationCallback
{
    ...
    * @param aParent
    */
   public static AeActivityCompensateImpl createImplicitCompensation(IAeActivityParent aParent)
   {
      return createImplicitCompensation(aParent, false);
   }
    ...
    */
   public static AeActivityCompensateImpl createImplicitCompensation(IAeActivityParent aParent, boolean aMatchCoordinated)
   { 
      AeActivityCompensateImpl implicitComp = new AeActivityCompensateImpl(null, aParent, aMatchCoordinated)
      {
         ...
         {
            throw new UnsupportedOperationException(AeMessages.getString("AeActivityCompensateImpl.ERROR_0")); //$NON-NLS-1$
         }
