// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/IAeBPELConstants.java,v 1.32 2007/06/10 19:07:5
/*
...
public interface IAeBPELConstants extends IAeConstants
{
   ...
   /** The preferred prefix for AE extenions. */
  ...
  // attributes tag names of a definition
   ...
   public static final String TAG_EXTENSIBLE_ASSIGN = "extensibleAssign"; //$NON-NLS-1$
  ...
  // standard element names of the activity definition
   ...
   public static final String TAG_DOCUMENTATION_SOURCE = "source";   //$NON-NLS-1$
   public static final String TAG_DOCUMENTATION_LANG   = "lang"; //$NON-NLS-1$
